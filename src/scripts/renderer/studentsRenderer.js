...
const fetchStudents=async ()=>{
    await fetch('http://localhost:3000/getAllStudents',{
        method:'GET',
        headers:{
        ...
        responseData.data.forEach((student)=>{
            ...
            <div class="rounded-full flex justify-center items-center border-2 border-black  absolute top-4 left-20"><img src="../../assets/profile12.png" class="h-[80px] w-[80px] rounded-full" alt=""></div>
